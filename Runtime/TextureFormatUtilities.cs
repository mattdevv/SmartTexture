...
public enum TextureCompressionLevel { Uncompressed, Compressed, CompressedHQ, CompressedLQ }
...
public static class TextureFormatUtilities
{
    ...
    public static TextureFormat GetRecommendedTextureFormat(TextureCompressionLevel compression, bool hasAlpha, bool isHDR, bool useCrunch)
    {
        TextureFormat none;
    ...
    public static GraphicsFormat GetRecommendedGraphicsFormat(TextureCompressionLevel compression, bool isSrgb, bool hasAlpha, bool isHDR)
    {
        return GraphicsFormatUtility.GetGraphicsFormat(GetRecommendedTextureFormat(compression, hasAlpha, isHDR, false), isSrgb);
    }
}
